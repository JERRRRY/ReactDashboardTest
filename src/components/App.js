...
import AutoInsertPost from './AutoInsertPost'; 
  ...
  render() {
    return (
        <div>
            ...
            <HashRouter>
            <Switch>
                <Route path="/" exact render={() => <Redirect to="/app/components/charts" />} />
                <Route path="/app" exact render={() => <Redirect to="/app/components/charts" />} />
